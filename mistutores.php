...
<!DOCTYPE html>
	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Mis Tutores | Tutoeri</title>
		            ...
		            <div class="row d-flex justify-content-center">
		                <div class="menu-content pb-40 col-lg-8">
		                    <div class="title text-center">
		                        <h1 class="mb-10">Mis Tutores</h1>
		                        <p>Cuando tengas alguna tutoría en curso aparecerá/n debajo...</p>
		                    </div>
		                </div>
		            </div>						
					<div class="row">
						...
						<?php
							...
							<div class="col-lg-4">
											...
											<div class="sidebar-widgets">
												<div class="widget-wrap">
													<div class="single-sidebar-widget user-info-widget">
														<img class="imgPerfil" src="./imagentutor/'.$row['imagen'].'" alt="">
														<a href="#"><h4 style="color: black;">'.$row['nombres'].' '.$row['apellidos'].'</h4></a>
								';

								$traerCalificacion = $pdo->query('SELECT COUNT(calificacion) as numero, TRUNCATE( AVG(calificacion),0) as promediotruncate, TRUNCATE( AVG(calificacion),1) as promedio 
								FROM calificaciones WHERE tutor_id = '.$row['id'].' AND calificacion!=0');
								...
								echo '
														<hr>
														<h5>[Tiempo]</h5>
														<h6>[Cantidad de dinero por el tiempo]</h6>
														<br>
													</div>
												</div>
											</div>		
										...
										<div class="text-center">
											<a class="price-btn col-lg-6" href="perfiltutor.php?id='.$row['id'].'">Ir al perfil</a>
										</div>
									</div>
								</div>
							</div>
